...
public class SkyNet {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if(SkyNet.toggle.isPressed()){
        	if(!SkyNet.isEnabled){
        	mc.thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.DARK_AQUA + "[SkyNet] "+ EnumChatFormatting.GRAY + "SkyNet Enabled"));
        	SkyNet.isEnabled = true;
        	}else if(SkyNet.isEnabled){
        	mc.ingameGUI.getChatGUI().printChatMessage(new ChatComponentText(EnumChatFormatting.DARK_AQUA + "[SkyNet] "+ EnumChatFormatting.GRAY + "SkyNet Disabled"));
